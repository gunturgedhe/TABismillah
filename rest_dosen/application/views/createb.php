...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Getting Electricity<span class="caret"></span></a>
      ...
      <div class="col-lg-6">
          ...
          <hr>
              ...
              <div class="panel-body">
                  <?php echo form_open('ge_pd/createb');?>
<table>
  <tr>
    <td>ID Pelanggan</td>
  ...
  <tr>
    <td>Tarif Awal</td>
    <td><?php echo form_input('trf_awal');?></td>
  </tr>
  <tr>
    <td>Daya Awal</td>
    <td><?php echo form_input('daya_awal');?></td>
  </tr>
  <tr>
    <td>Tarif Baru</td>
    <td><?php echo form_input('trf_baru');?></td>
  </tr>
  <tr>
    <td>Daya Baru</td>
    <td><?php echo form_input('daya_baru');?></td>
  </tr>
  <tr>
