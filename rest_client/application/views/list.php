...
<nav class="navbar navbar-default">
  <div class="container-fluid">
    ...
    <li><a  href="http://localhost/TABISMILLAH/login/index.php/login"><span class="glyphicon glyphicon-log-in"></span> Logout</a></li>
    </ul>
  </div>
</nav>
                      ...
                      <tbody>
                        ...
                        foreach ($dosen as $m){
                          ...
                          <td>$m->kddospem</td>                                
                            ...
                            ".anchor('dosen/delete/'.$m->kddospem,'Delete')."</td>
                          </tr>";                                  }
                        ?>
                      </tbody>
                  </table>
